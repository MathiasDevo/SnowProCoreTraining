...
SELECT t.$1 FROM @blob_stage/raw_pos/menu/ t;
...
-------------------------------------------------------------------------------------------
    -- Step 5: Try time travel functionalities
-------------------------------------------------------------------------------------------
...
SELECT * FROM menu AT(TIMESTAMP => '2026-03-10 06:31:17.475 -0700'::TIMESTAMP_LTZ);

---> get the database state from an offset of the current time
SELECT * FROM menu AT(OFFSET => -60*1);

---> get the database state before a transaction occurred
SELECT * FROM menu BEFORE(STATEMENT => '01c2ef6f-0005-1422-0001-476a00018516');
...
CREATE TABLE menu_restored CLONE menu
  BEFORE(STATEMENT => '01c2ef6f-0005-1422-0001-476a00018516');
