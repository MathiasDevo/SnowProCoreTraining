...
-- 2026-03-10 06:31:21.893 -0700
SELECT * FROM menu AT(TIMESTAMP => '2026-03-10 06:31:21.893 -0700'::TIMESTAMP_LTZ);
...
SELECT * FROM menu BEFORE(STATEMENT => '01c2ef6b-0005-1426-0001-471a0001a0d2');
